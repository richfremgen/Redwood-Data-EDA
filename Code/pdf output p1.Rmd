...
### 2 - Part (a) Check Histograms of Variables 
...
```{r, figures-temp_trend_week, fig.show = "hold", fig.cap='Temporal Trends of Variables from May 1st - May 7th', fig.align="center", out.width="40%", fig.ncol = 1, echo=FALSE}
# Humidity Trend
sonoma_tp %>%
...
```{r, figures-temp_trend_day, fig.show = "hold", fig.cap='Temporal Trends of Variables from May 1st', fig.align="center", out.width="40%", fig.ncol = 1, echo=FALSE}
# Humidity Trend
sonoma_tp_day %>%
  ggplot(aes(x = epoch_Dates, y = humidity)) +
  geom_line(aes(color = Height)) +
